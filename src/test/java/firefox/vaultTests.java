...
public class vaultTests extends TestCase {
    ...
    @Before
    public void setUp() {
        System.setProperty("webdriver.gecko.driver", "/Users/michaelremes/documents/driver/firefox/geckodriver");
...
//
//    public void testLoadVaultHomePage() {
//
//        // wait for homepage
...
//
//        // go to vaults
//        driver.findElement(By.xpath("/html/body/app-root/app-dashboard/app-left-menu/div/ul/li[2]/a/span")).click();
//
//
//        driver.close();
//
...
//
    public void testCreateNewVault() throws InterruptedException {
        ...
        //submit
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/jw-modal[8]/div[1]/div/div[2]/form/button/span")));
...
//        driver.findElement(By.xpath("/html/body/app-root/app-vaults/listing/div[2]/div[5]/div/div[2]/div[2]/table/tbody/tr/td[6]/a/i")).click();
//
//
//        //delete created Vault
//        driver.findElement(By.xpath("/html/body/app-root/app-vaults/listing/div[2]/div[5]/div/div[2]/div[2]/table/tbody/tr/td[6]/div/a[1]")).click();
//
//
//        //exit deletion
...
//
//        // check if Selenium Vault was deleted
//      //  assertFalse(IsElementPresentByName(driver, "Selenium New Vault"));
//
//        driver.close();
//
//    }
